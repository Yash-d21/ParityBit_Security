...
export const ctaContent = {
  ...
  booking: {
    ...
    subtitle:
      'Thirty-minute working session with one of our analysts. Pick the path that matches your team.',
    cards: [
      {
        audience: 'For MSPs & channel partners',
        title: 'Book a Partner Fit Call',
        description:
